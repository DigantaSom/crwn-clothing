...
// did not import the default CartDropdown because it's wrapped in HOCs.
...
describe('CartDropdown component', () => {
  ...
  it('should render EmptyMessageContainer if cartItems is empty', () => {
    const mockProps_emptyCartItems = {
      cartItems: [],
      history: mockHistory,
      dispatch: mockDispatch,
    };
    const newWrapper = shallow(<CartDropdown {...mockProps_emptyCartItems} />);
